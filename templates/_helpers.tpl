    ...
    command:
      ...
      - |
          ...
          runtime_vars="$(mktemp)"
          {
            ...
            echo "s4_s4:"
            echo "  endpointProtocol: \"{{ $.Values.s4Role.endpoint.protocol }}\""
            echo "  endpointAddress: \"{{ include "vp-s4-storage.s4.endpointAddress" $ }}\""
            echo "  endpointPort: {{ $.Values.s4Role.endpoint.port }}"
